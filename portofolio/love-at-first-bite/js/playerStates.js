...
export class Sitting extends State {
    ...
    handleInput(input){
        if (input.includes('ArrowLeft') || input.includes('ArrowRight')) this.game.player.setState(states.RUNNIG, 1);
        else if (input.includes('s')) this.game.player.setState(states.ROLLING, 2);
    }
}
...
export class Falling extends State {
    ...
    handleInput(input){
        if (this.game.player.onGround()) this.game.player.setState(states.RUNNIG, 1);
        else if (input.includes('ArrowDown')) this.game.player.setState(states.DIVING, 0)
    }
}
...
export class Rolling extends State {
    ...
    handleInput(input){
        ...
        if (!input.includes('s') && this.game.player.onGround()) this.game.player.setState(states.RUNNIG, 1);
        else if (!input.includes('s') && !this.game.player.onGround()) this.game.player.setState(states.FALLING, 1);
        else if (input.includes('s') && input.includes('ArrowUp') && this.game.player.onGround()) this.game.player.vy -= 25;
...
export class Diving extends State {
    ...
    handleInput(input){
        ...
        if (this.game.player.onGround()) {
            this.game.player.setState(states.RUNNIG, 1);
            for (let i = 0; i < 30; i++) {
        ...
        else if (input.includes('s') && this.game.player.onGround()) this.game.player.setState(states.ROLLING, 2);
...
export class Hit extends State {
    ...
    handleInput(input){
        if (this.game.player.frameX >= 10 && this.game.player.onGround()) this.game.player.setState(states.RUNNIG, 1);
